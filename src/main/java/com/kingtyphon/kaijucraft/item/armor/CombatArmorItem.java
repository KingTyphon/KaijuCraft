...
public class CombatArmorItem extends ArmorItem implements GeoItem {
    ...
    public CombatArmorItem(ArmorMaterial material, ArmorItem.Type type, Item.Properties properties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer){
        consumer.accept(new IClientItemExtensions() {
            private CombatArmorRenderer renderer;

            @Override
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original){
                if(this.renderer == null) {this.renderer = new CombatArmorRenderer();}
