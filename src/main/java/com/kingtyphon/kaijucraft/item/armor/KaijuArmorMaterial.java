...
public enum KaijuArmorMaterial implements ArmorMaterial {

    KAIJU("kaiju", 37, (EnumMap)Util.make(new EnumMap(ArmorItem.Type.class), (p_266655_) -> {
    ...
    private KaijuArmorMaterial(String p_268171_, int p_268303_, EnumMap p_267941_, int p_268086_, SoundEvent p_268145_, float p_268058_, float p_268180_, Supplier p_268256_) {
        this.name = p_268171_;
