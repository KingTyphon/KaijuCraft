...
public class KaijuSounds {
    ...
    public static final RegistryObject<SoundEvent> AXESWOOSH = registerSoundEvents("axeswoosh");
    public static final RegistryObject<SoundEvent> SWORD = registerSoundEvents("sword");
